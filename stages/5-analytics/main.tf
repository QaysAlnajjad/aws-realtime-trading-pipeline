...
module "analytics" {
  ...
  athena_results_bucket = var.athena_results_bucket_config
  glue_database_name = var.glue_database_name_config
  glue_crawler_name = var.glue_crawler_name_config
  athena_workgroup_name = var.athena_workgroup_name_config
}